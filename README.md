# Abhishek Kanoujiya - Developer Portfolio

A modern developer portfolio website built using **Next.js (App Router)**, **TypeScript**, and **Tailwind CSS**. It is structured in a dark-mode first layout featuring glassmorphism elements, curated color transitions, and custom micro-animations.

## 🛠️ Technology Stack
* **Framework:** Next.js (App Router)
* **Language:** TypeScript
* **Styling:** Tailwind CSS (custom dark theme configurations)
* **Icons:** Lucide React & Custom Brand SVGs
* **Contact API:** FormSubmit.co AJAX API (delivers messages directly to email)
